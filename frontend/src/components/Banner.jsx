  ...
  return (
    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row  ">
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32">
          ...
          <p className=" text-xl ">
          Your one-stop-shop for books! Buy, rent, and read from our diverse collection spanning genres. Join our community and dive into your next literary adventure today!
          </p>
